...
<head>
    ...
    <link rel="stylesheet" href="/css/home.css"> <!-- Lien vers votre CSS -->
    <style>
        ...
        /* After animation: infinite background */
        body {
            margin: 0;
            font-family: Arial, sans-serif;
        ...
        /* Form styles (from your original CSS) */
        .gamos-container {
            width: 100%;
            max-width: 1200px;
            margin: 0 auto;
        ...
        .gamos-form-container {
            ...
            margin-top: 30px;
            text-align: center;
            backdrop-filter: blur(5px); /* Add blur effect to make text stand out */
        }
